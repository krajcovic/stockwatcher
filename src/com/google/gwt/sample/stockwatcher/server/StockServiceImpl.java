...
import com.google.gwt.sample.stockwatcher.client.domain.Stock;
...
public class StockServiceImpl extends RemoteServiceServlet implements
	 ...
	 * 
	 */
	private static final long serialVersionUID = 373295309773537276L;
	...
	public void removeStock(String symbol) throws NotLoggedInException {
		...
		try {
			...
			if (deleteCount != 1) {
				LOG.log(Level.WARNING, "removeStock delted " + deleteCount
						+ " Stocks");
			}
		} finally {
			pm.close();
